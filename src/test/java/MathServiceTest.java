...
public class MathServiceTest {
    ...
    void testPairToString() {
        Pair pair = new Pair(2.568, -1.55);
        Assertions.assertEquals("Answer{first=2.568, second=-1.55}", pair.toString());
    }

    @ParameterizedTest
    @CsvSource({"2, 4, 2, 0", "2, -4, 2, 0", "1, 3, -4, 25", "-1, 3, 4, 25", "-10, -10, -10, -300", "1, 5, 1, 21"})
    ...
    @ParameterizedTest
    @CsvSource({"2, 4, 2, -1.0", "16, -8, 1, 0.0"})
